...
keywords: ["Padrón", "constancia de inscripción", "condición de IVA", "CUIT", "DNI", "A5", "A13"]
---
...
inscripciones, así que su ausencia no prueba nada. Las dos veces el SDK no
adivina, y la decisión queda en tu aplicación: pedísela al cliente o revisá
`taxes` y `raw`.
...
estar asociado a más de una persona. Elegí con tu cliente antes de facturar.
Devuelve `null` cuando ARCA no encuentra el documento.
