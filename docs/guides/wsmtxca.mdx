---
title: "WSMTXCA"
description: "Emití comprobantes con detalle de ítems mediante WSMTXCA desde la API de alto nivel o exacta."
...
API de alto nivel lo cubre con los mismos métodos que WSFE.
...
WSMTXCA. Ver [Stores](/guides/idempotency-stores#store-propio-y-vida-de-los-registros).
