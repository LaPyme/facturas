---
title: "WSMTXCA"
description: "Emití comprobantes con detalle de ítems mediante WSMTXCA."
keywords: ["WSMTXCA", "detalle de ítems", "CAE", "FCE"]
---

WSMTXCA es el otro servicio de CAE de ARCA. Su diferencia con WSFE es el
detalle: cada comprobante lleva sus ítems, no solo la cabecera fiscal.
`issue()`, las notas y las vistas previas funcionan con ambos servicios.
...
`ArcaInputError` con el índice del ítem y el campo. WSFE ignora estos campos y
arma su cabecera igual que siempre.
...
El SDK arma las dos codificaciones del proveedor. La aplicación no construye
listas SOAP.
