...
vuelve a guardar cifrado en la primera lectura y se borra de la clave vieja,
porque ARCA rechaza un login nuevo mientras ese ticket vive. El `withLock` de
los tickets sigue usando la clave `arca:v1:wsaa:`, así que un despliegue con
las dos versiones conviviendo sigue serializando sus logins. Los registros de
