---
title: "Configuración"
description: "Configurá credenciales, ambiente, sesiones WSAA, logging, reintentos y timeouts."
keywords: ["configuración", "variables de entorno", "WSAA", "logging", "timeouts"]
---
