---
title: "Habilitación en ARCA"
description: "Prepará el CUIT, certificado, servicios y punto de venta para homologación o producción."
keywords: ["ARCA", "certificado", "WSAA", "punto de venta", "homologación"]
---

<Info>
  Este paquete no da de alta tus credenciales de ARCA. La configuración oficial de certificados y servicios se hace fuera del SDK.
</Info>
...
en ARCA. Están en [CLI](/getting-started/cli).
...
mantenedores, en [Fuentes y reglas de ARCA](/reference/arca-sources).
