...
[Habilitación en ARCA](/getting-started/arca-setup); los comandos, en
...
está en
[Contrato fiscal de la API de alto nivel](/guides/invoices#contrato-fiscal-de-la-api-de-alto-nivel).
...
Creá una vez la tabla [Postgres](/guides/idempotency-stores#postgres) y usá:
...
sobrevive al reinicio del proceso. Están todos en [Stores](/guides/idempotency-stores).
...
la nota. La misma API de alto nivel emite notas de débito y notas por período: está todo
